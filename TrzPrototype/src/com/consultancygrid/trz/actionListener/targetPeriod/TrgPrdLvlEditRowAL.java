...
public class TrgPrdLvlEditRowAL extends BaseActionListener{

	private TargetLevelCfgTable tLvlConfTable;
	private JComboBox comboBoxTargetPeriod;
	private HashMap<TrzStatic, JTextField> map ;
	
	public TrgPrdLvlEditRowAL(PrototypeMainFrame mainFrame,JComboBox comboBoxTargetPeriod, TargetLevelCfgTable tLvlConfTable) {
		super(mainFrame);
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			saveBtn.addActionListener(new TrgPrdLvlSaveEditRowAL(mainFrame, tLvlConfTable, comboBoxTargetPeriod , map, popUp));
			panel.add(saveBtn);
