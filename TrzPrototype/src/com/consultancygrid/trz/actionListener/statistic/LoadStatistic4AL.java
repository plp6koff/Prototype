...
import com.consultancygrid.trz.ui.table.personal.statistic4.PrsStat4Util;
...
public class LoadStatistic4AL extends BaseActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			init();
			PrsStat4CfgEmplsTableModel model = new PrsStat4CfgEmplsTableModel();
			...
			exportButt.addActionListener(new ExportStatistic34AL(mainFrame, fc, personalConfTable));
