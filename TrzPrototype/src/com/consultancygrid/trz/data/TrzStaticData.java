...
public class TrzStaticData {
	...
	private Double dodValue = 0.0d;;
	private Double oRabotodatelValue = 0.0d;;
	private Double oSlujitelValue = 0.0d;;
	private Double cacheTaxValue = 0.0d;;
	private Double vauchers = 0.0d;;
