...
public class PrsStat2CfgEmplsTable extends JTable {
	...
	public PrsStat2CfgEmplsTable() throws IOException {
		
		setAutoResizeMode(AUTO_RESIZE_ALL_COLUMNS);
		setBorder(new EmptyBorder(1, 1, 1, 1));
		setModel(new PrsStat2CfgEmplsTableModel());
		...
		getColumnModel().getColumn(22).setMinWidth(80);
		getColumnModel().getColumn(23).setMinWidth(80);
		setRowHeight(25);
	}
